...
function _loadSpritesheets() {
  ...
  game.load.spritesheet("sprOrcs1", "game/assets/spritesheets/orc_units.png", 32, 32);
  game.load.spritesheet("sprOrcs2", "game/assets/spritesheets/orc_units2.png", 32, 32);
